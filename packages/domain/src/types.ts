...
export interface InventoryDraft { itemName:string; category:string; location:string; make:string; model:string; serialNumber:string; userDescription:string; userEnteredValue?:number; condition:ItemCondition; }
